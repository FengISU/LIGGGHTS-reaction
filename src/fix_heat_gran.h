...
namespace LAMMPS_NS {
  ...
  protected:
    ...
    //addding heat flux distribution to account for heat transfer in different pathways
    class FixPropertyAtom* fix_heatFluxDistribution;
    double **heatFluxDistribution; // order: conduction in contact, contacting pfp, noncontacting pfp
